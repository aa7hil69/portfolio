          ...
          <div className="flex h-13 md:h-20 items-center justify-between">
            ...
            >
              ...
              <a
                href="/jj2"
                className="group relative flex items-center"
                aria-label="JJ2 Consultancy UK Limited — coming soon"
              >
                <div className="h-12 w-12 sm:h-14 sm:w-14 md:h-16 md:w-16 rounded-full ring-2 ring-white/15 bg-white/0 grid place-items-center transform transition-transform duration-200 ease-out group-hover:scale-110">
                  <img
            ...
            >
              ...
              <a
                href="https://www.facebook.com/jessy.mathew"
          ...
          <div className="h-full bg-[#0a2557]/85 backdrop-blur-md border-l border-white/10 text-white shadow-xl">
            ...
            <div className="px-4 pb-8 pt-4 space-y-8">
              <div className="flex items-center gap-3 sm:gap-4">
                <a href="https://jminternationalspc.com/" {...extProps} aria-label="Jessy Mathew International SPC">
                  <img src="/logopics/logo1.png" alt="Jessy Mathew International SPC" className="h-10 w-10 sm:h-12 sm:w-12 rounded-full ring-1 ring-white/10" />
                </a>
                <a href="https://camdenexim.com" {...extProps} aria-label="Camden Importers and Exporters Pvt Ltd">
                  <img src="/logopics/logo3.png" alt="Camden Importers and Exporters Private Limited" className="h-9 w-9 sm:h-11 sm:w-11 rounded-full ring-1 ring-white/10" />
                </a>
                <a href="/jj2" aria-label="JJ2 Consultancy UK Limited — coming soon">
                  <img src="/logopics/logo2.png" alt="JJ2 Consultancy UK Limited" className="h-8 w-8 sm:h-10 sm:w-10 rounded-full ring-1 ring-white/10" />
                </a>
              </div>
