  ...
  return (
    ...
    >
      <div className="w-full max-w-7xl">
        ...
        <motion.div
          ref={ref}
          className="relative text-center mb-10 px-2"
          variants={stagger}
          initial="hidden"
          whileInView="show"
          viewport={{ amount: 0.6 }}
        >
          ...
          <motion.p
            variants={slideUp}
            className="text-white/80 text-sm sm:text-base md:text-lg max-w-3xl mx-auto mt-4"
          >
            Explore our curated partner brands. Each tile highlights the company
            name and logo with a direct link to learn more.
          </motion.p>
        </motion.div>
          ...
          >
            {[  
              ...
              <motion.a
                ...
                className="group relative block bg-[#173e88] cursor-pointer
              ...
              >
                ...
                <div className="relative z-10 flex flex-col items-center text-center px-6 py-8">
                  {/* TITLE TOP */}
                  <h3 className="font-teko text-xl sm:text-2xl md:text-3xl font-bold text-white mb-6">
                    {title}
                  </h3>
                  ...
                  {/* CTA */}
                  <span className="mt-6 rounded-full bg-[#0c1f40]
                                   py-2 px-5 font-teko text-xs sm:text-sm
                                   uppercase tracking-wide text-white
                                   shadow shadow-black/60
                                   transition-colors group-hover:bg-[#0f264f]">
                    {isInternal ? "Coming Soon" : "Visit Website"}
                  </span>
                </div>

                {/* ====== OVERLAY ====== */}
                <div className="absolute inset-0 pointer-events-none">
                  <div className="absolute inset-0 bg-gradient-to-b from-[#0b1d3a]/30 via-[#0b1d3a]/50 to-[#0b1d3a]/80" />
                </div>
              </motion.a>
            );
            })}
